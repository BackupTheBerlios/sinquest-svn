...
import de.u808.simpleinquest.config.SimpleInquestConfig;
...
public class SimpleInquestServlet extends DispatcherServlet {
    ...
    private void loadSystemConfig() {
        ...
        JavaConfigApplicationContext context = new JavaConfigApplicationContext(SimpleInquestConfig.class);
        ConfigurationValidatorBean configurationValidatorBean = context.getBean(ConfigurationValidatorBean.class);

        List<ConfigurationError> errors = configurationValidatorBean.validate();
    ...
    private void initQuarz() {
        try {
            ...
            // FileIndexer Task
            // for testing
            // CronTrigger cronTrigger = new CronTrigger("FileIndexerTrigger",
            // "IndexerGroup");
            ...
            JobDetail jobDetail = new JobDetail("FileIndexerJob", SchedulerManager.INDEXER_GROUP, FileIndexerJob.class);

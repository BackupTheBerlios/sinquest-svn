...
public class MimeUtil {
	...
	public static String getMimeType(File file) {
		...
		mimeType = MimeUtil.getMimeTypeByExtention(MimeUtil.getFileExtension(file));
		if(mimeType != null){
			return mimeType;
		}
		try {
	...
	public static String getMimeType(String fname) {
		...
		String mimeType = MimeUtil.getMimeTypeByExtention(MimeUtil.getFileExtension(fname));
		if(StringUtils.isNotEmpty(mimeType)){
			return mimeType;
		}
		else return MimeUtil.getMimeType(new File(fname));
	}
	
	private static String getMimeTypeByExtention(String fileExtension){
		String mimeType = null;
		if(StringUtils.isEmpty(fileExtension)){
			return null;
		}
		// First try case sensitive
		mimeType = (String)mimeTypes.get(fileExtension);
		if(mimeType == null || "".equals(mimeType.trim())) {
			//try again case insensitive (lower case)
			mimeType = (String)mimeTypes.get(fileExtension.toLowerCase());
		}
		return mimeType;
	}
